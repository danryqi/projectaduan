...
<head>
  ...
  <style>
    .form-control {
      background-color: #eaeaea; /* abu muda */
      border-color: #dee2e6;
...
<body class="bg-light">
  <div class="d-flex justify-content-center align-items-center" style="min-height: 100vh;">
    <div class="row gap-4 bg-white shadow p-4 rounded d-flex align-items-center" 
         style="max-width: 1000px; width: 100%; height: 350px; max-height: 100vh;">
      ...
      <div class="col-md-5">
        <h5 class="mb-4 ms-1">Register Page</h5>
        <form action="../app/proses_register.php" method="POST" class="d-grid gap-3">
          ...
          <input id="password" name="password" type="password" 
                 placeholder="Masukkan password (maks. 15 karakter)" required maxlength="15" class="form-control" />

          <button type="submit" class="btn btn-warning text-white px-4">Daftar</button>
          <a href="login.php" class="text-sm text-muted text-decoration-none">Sudah punya akun? Login</a>
        </form>
      </div>
    </div>
  </div>
