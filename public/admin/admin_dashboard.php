...
include __DIR__ . '/config_dashboard.php';
...
<main class="justify-content-center align-items-center" style="min-height: 40vh; margin: 0 110px;">
  ...
  ">
    <div class="card-body">
      <h5 class="card-title text-warning fw-bold mb-3">Total Pengguna</h5>
  ...
  <div class="row d-flex">
    ...
    <div class="col-3">
        ...
        ">
            ...
            <h2 class="fw-semibold text-dark mb-0"><?= htmlspecialchars($data_ditanggapi['total_ditanggapi'] ?? 0) ?></h2>
            </div>
        </div>
    </div>
    <div class="col-3">
